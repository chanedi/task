 ...
 */
@Tag("XPathSuperResponseHandler")
public final class XPathSuperResponseHandler extends SelectorBasedSuperResponseHandler {
  ...
  public XPathSuperResponseHandler() {
    // empty
  }

  public XPathSuperResponseHandler(SuperGenericRepository repository) {
    super(repository);
  }
